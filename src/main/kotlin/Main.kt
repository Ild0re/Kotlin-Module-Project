...
fun main(args: Array<String>) {
    ...
    chooseArchiveMenu(listOfArchives)
}

private fun chooseArchiveMenu(listOfArchives: MutableList<Archive>) {
    while (true) {
...
private fun chooseNoteMenu(i: Archive) {
    while (true) {
        println("Пожалуйста, введите команду, которую необходимо выполнить:")
